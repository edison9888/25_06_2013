...
- (void)createTabBar
{
    ...
    TabbarHomeViewController* tabbarHomeViewController = [[TabbarHomeViewController alloc] init];
    
    tabbarHomeViewController.title = @"Home";
    
    JobViewController* jobViewController = [[JobViewController alloc] init];
    
    jobViewController.title = @"Request";
    
    UINavigationController *settingNavigationController=[[UINavigationController alloc]initWithRootViewController:jobViewController];
    
    NSArray* controllers = [NSArray arrayWithObjects:tabbarHomeViewController,settingNavigationController, nil];
