...
{
    //cheching request date is there
...
- (void)restoreView
{
    ...
    JobRequestViewController* jobViewController = [[JobRequestViewController alloc] init];
    jobViewController.hidesBottomBarWhenPushed = YES;
...
- (void)showJobRequestViewWithTitle:(NSString*)title
{
    ...
    jobRequestViewController.hidesBottomBarWhenPushed = YES;
